...
const CONTENT = [
  {
    title: 'Welcome to React Cairo!',
    content: (() => (
      <>
        These terms and conditions outline the rules and regulations for the use
        of React Cairo&apos;s Website, located at
        <Link href="https://reactcairo.com" className="text-brand-300">
          {`  https://reactcairo.com`}
        </Link>
        .
        <br />
        <br />
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use React Cairo if you do not agree to
        ...
        prevailing law of eg. Any use of the above terminology or other words in
  ...
  },
  {
    ...
    content: (() => (
      <>
        We employ the use of cookies. By accessing React Cairo, you agreed to
        use cookies in agreement with the React Cairo&apos;s Privacy Policy.
        <br />
        <br />
  ...
  },
  {
    ...
    content: (() => (
      <>
        Unless otherwise stated, React Cairo and/or its licensors own the
        intellectual property rights for all material on React Cairo. All
        intellectual property rights are reserved. You may access this from
        React Cairo for your own personal use subjected to restrictions set in
        these terms and conditions.
        <br />
        <br />
        You must not:
        <ul className="list-disc list-inside">
          <li>Republish material from React Cairo</li>
          <li>Sell, rent or sub-license material from React Cairo</li>
          <li>Reproduce, duplicate or copy material from React Cairo</li>
          <li>Redistribute content from React Cairo</li>
        </ul>
        <br />
        <br />
        ...
        exchange opinions and information in certain areas of the website. React
        Cairo does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of React Cairo,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, React Cairo shall not be liable for
        ...
        <br />
        <br />
        React Cairo reserves the right to monitor all Comments and to remove any
        ...
        <br />
        <br />
        You hereby grant React Cairo a non-exclusive license to use, reproduce,
  ...
  },
  {
    ...
    content: (() => (
      <>
        ...
        the hyperlink compensates the absence of React Cairo; and (d) the link
        ...
        e-mail to React Cairo. Please include your name, your organization name,
        ...
        <br />
        No use of React Cairo&apos;s logo or other artwork will be allowed for
