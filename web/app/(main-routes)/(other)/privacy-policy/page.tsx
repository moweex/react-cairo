...
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Free Privacy Policy Generator.`,
  },
  {
    ...
    content: (() => (
      <>
        <h6 className="text-2xl text-left sm:text-4xl text-brand-300">
          Interpretation
        </h6>
        <div>
    ...
    content: (() => (
      <>
        ...
        <ul className="list-disc list-inside">
          <li>
            <span>
              <strong className="text-brand-300">Account:</strong> means a
          ...
          <li>
            <span>
              <strong className="text-brand-300">Affiliate:</strong> means an
          ...
          <li>
            <span>
              <strong className="text-brand-300">Company:</strong> (referred to
              as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this Agreement) refers to React Cairo, 15
              Mahmoud Hafez, Heliopolis .
            </span>
          </li>
          <li>
            <span>
              <strong className="text-brand-300">Cookies:</strong> are small
          ...
          <li>
            <span>
              <strong className="text-brand-300">Country:</strong> refers to:
              Egypt
            </span>
          </li>
          <li>
            <span>
              <strong className="text-brand-300">Device:</strong> means any
          ...
          <li>
            <span>
              <strong className="text-brand-300">Personal Data:</strong> is any
          ...
          <li>
            <span>
              <strong className="text-brand-300">Service:</strong> refers to the
              Website.
            </span>
          </li>
          <li>
            <span>
              <strong className="text-brand-300">Service Provider:</strong>{' '}
          ...
          <li>
            <span>
              <strong className="text-brand-300">Usage Data:</strong> refers to
          ...
          <li>
            <span>
              <strong className="text-brand-300">Website:</strong> refers to
              React Cairo, accessible from https://www.react-cairo.com/
            </span>
          </li>
          <li>
            <span>
              <strong className="text-brand-300">You:</strong> means the
    ...
    content: (() => (
      <>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <strong className="text-brand-300">Web Beacons.</strong> Certain
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <strong className="text-brand-300">Functionality Cookies</strong>
            <br />
            Type: Persistent Cookies
            <br />
            Administered by: Us
    ...
    content: (() => (
      <>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <strong className="text-brand-300">To manage Your Account:</strong>{' '}
          ...
          <li>
            <strong className="text-brand-300">To contact You:</strong> To
          ...
          <li>
            <strong className="text-brand-300">To provide You</strong> with
          ...
          <li>
            <strong className="text-brand-300">To manage Your requests:</strong>{' '}
            To attend and manage Your requests to Us.
          </li>
          <li>
            <strong className="text-brand-300">For business transfers:</strong>{' '}
          ...
          <li>
            <strong className="text-brand-300">For other purposes</strong>: We
          ...
          <li>
            <strong className="text-brand-300">With Service Providers:</strong>{' '}
          ...
          <li>
            <strong className="text-brand-300">With Affiliates:</strong> We may
          ...
          <li>
            <strong className="text-brand-300">With business partners:</strong>{' '}
            We may share Your information with Our business partners to offer
            You certain products, services or promotions.
          </li>
          <li>
            <strong className="text-brand-300">With other users:</strong> when
          ...
          <li>
            <strong className="text-brand-300">With Your consent:</strong> We
...
export default async function PrivacyAndPolicyPage() {
  return (
