    ...
    <div className="h-screen center z-10">
      <div className="flex flex-col items-center justify-center h-full space-y-4">
        ...
        <p className="text-xl text-center">
          Please verify your Email to get your ticket
        </p>
        <p className="text-lg text-center text-red-500 font-bold">
          Verification must be completed within 12 hours
        </p>
        <button
          className={
            disabled
        ...
        <a
          href="mailto:reactcairo@moweex.com"
